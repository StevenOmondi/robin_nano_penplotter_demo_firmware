...
#if IS_2D
  #define CUSTOM_MACHINE_NAME "Pen Plotter"
#else
  #define CUSTOM_MACHINE_NAME "Pen Plotter"
#endif
 ...
 */
//#define PIDTEMP           // Plotter-only build: no hotend heater.
 ...
 */
//#define PIDTEMPBED        // Plotter-only build: no heated bed.
...
//#define LCD_BED_TRAMMING  // Plotter-only build: no bed leveling/tramming menu.
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_IDLE_SLEEP_MINS 0   // Keep LVGL display awake on this plotter build.
 ...
 */
//#define NUM_SERVOS 1 // Servo index starts with 0 for M280-M282 commands
