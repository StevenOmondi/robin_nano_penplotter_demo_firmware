...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 3*60 } // (mm/min) Feedrates for manual moves along X, Y, Z from panel
...
#ifndef DISPLAY_SLEEP_MINUTES
  #define DISPLAY_SLEEP_MINUTES 0  // Fallback for LVGL/touch builds; touch sleep uses TOUCH_IDLE_SLEEP_MINS.
#endif
...
// Embed current pen plotter examples in firmware. Run with M750 D<demo>.
#define PENPLOTTER_EMBEDDED_DEMOS

// Custom Menu: Main Menu
#define CUSTOM_MENU_MAIN
#if ENABLED(CUSTOM_MENU_MAIN)
  #define CUSTOM_MENU_MAIN_TITLE "Plotter Apps"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 Plotter command done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  #define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  #define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Setup"
  #define MAIN_MENU_ITEM_1_GCODE "M751 A"
  //#define MAIN_MENU_ITEM_1_CONFIRM

  #define MAIN_MENU_ITEM_2_DESC "Lift"
  #define MAIN_MENU_ITEM_2_GCODE "M751 U"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "Draw"
  #define MAIN_MENU_ITEM_3_GCODE "M751 D"
  //#define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "Origin"
  #define MAIN_MENU_ITEM_4_GCODE "M751 O"
  //#define MAIN_MENU_ITEM_4_CONFIRM

  #define MAIN_MENU_ITEM_5_DESC "Speed 50%"
  #define MAIN_MENU_ITEM_5_GCODE "M751 S50"
  //#define MAIN_MENU_ITEM_5_CONFIRM

  #define MAIN_MENU_ITEM_6_DESC "Speed 100%"
  #define MAIN_MENU_ITEM_6_GCODE "M751 S100"
  //#define MAIN_MENU_ITEM_6_CONFIRM

  #define MAIN_MENU_ITEM_7_DESC "Speed 150%"
  #define MAIN_MENU_ITEM_7_GCODE "M751 S150"
  //#define MAIN_MENU_ITEM_7_CONFIRM

  #define MAIN_MENU_ITEM_8_DESC "Speed 200%"
  #define MAIN_MENU_ITEM_8_GCODE "M751 S200"
  //#define MAIN_MENU_ITEM_8_CONFIRM

  #define MAIN_MENU_ITEM_9_DESC "Center"
  #define MAIN_MENU_ITEM_9_GCODE "M751 P"
  //#define MAIN_MENU_ITEM_9_CONFIRM

  #define MAIN_MENU_ITEM_10_DESC "Dry Frame"
  #define MAIN_MENU_ITEM_10_GCODE "M751 R"
  #define MAIN_MENU_ITEM_10_CONFIRM

  #define MAIN_MENU_ITEM_11_DESC "Trace Frame"
  #define MAIN_MENU_ITEM_11_GCODE "M751 T"
  #define MAIN_MENU_ITEM_11_CONFIRM

  #define MAIN_MENU_ITEM_12_DESC "Center Square"
  #define MAIN_MENU_ITEM_12_GCODE "M751 Q"
  #define MAIN_MENU_ITEM_12_CONFIRM

  #define MAIN_MENU_ITEM_13_DESC "Demo List"
  #define MAIN_MENU_ITEM_13_GCODE "M750"
  //#define MAIN_MENU_ITEM_13_CONFIRM

  #define MAIN_MENU_ITEM_14_DESC "Demo Cal Square"
  #define MAIN_MENU_ITEM_14_GCODE "M750 D4"
  #define MAIN_MENU_ITEM_14_CONFIRM

  #define MAIN_MENU_ITEM_15_DESC "Demo Grid"
  #define MAIN_MENU_ITEM_15_GCODE "M750 D21"
  #define MAIN_MENU_ITEM_15_CONFIRM

  #define MAIN_MENU_ITEM_16_DESC "Demo Frame"
  #define MAIN_MENU_ITEM_16_GCODE "M750 D18"
  #define MAIN_MENU_ITEM_16_CONFIRM

  #define MAIN_MENU_ITEM_17_DESC "Demo Spiral"
  #define MAIN_MENU_ITEM_17_GCODE "M750 D43"
  #define MAIN_MENU_ITEM_17_CONFIRM

  #define MAIN_MENU_ITEM_18_DESC "Demo Mandala"
  #define MAIN_MENU_ITEM_18_GCODE "M750 D32"
  #define MAIN_MENU_ITEM_18_CONFIRM

  #define MAIN_MENU_ITEM_19_DESC "Demo Flower"
  #define MAIN_MENU_ITEM_19_GCODE "M750 D17"
  #define MAIN_MENU_ITEM_19_CONFIRM

  #define MAIN_MENU_ITEM_20_DESC "Demo Cat"
  #define MAIN_MENU_ITEM_20_GCODE "M750 D5"
  #define MAIN_MENU_ITEM_20_CONFIRM

  #define MAIN_MENU_ITEM_21_DESC "Demo Face"
  #define MAIN_MENU_ITEM_21_GCODE "M750 D6"
  #define MAIN_MENU_ITEM_21_CONFIRM

  #define MAIN_MENU_ITEM_22_DESC "Demo Robot"
  #define MAIN_MENU_ITEM_22_GCODE "M750 D7"
  #define MAIN_MENU_ITEM_22_CONFIRM

  #define MAIN_MENU_ITEM_23_DESC "Demo Rocket"
  #define MAIN_MENU_ITEM_23_GCODE "M750 D8"
  #define MAIN_MENU_ITEM_23_CONFIRM

  #define MAIN_MENU_ITEM_24_DESC "Demo Words"
  #define MAIN_MENU_ITEM_24_GCODE "M750 D49"
  #define MAIN_MENU_ITEM_24_CONFIRM

  #define MAIN_MENU_ITEM_25_DESC "Demo Word Art"
  #define MAIN_MENU_ITEM_25_GCODE "M750 D48"
