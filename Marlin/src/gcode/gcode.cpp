  ...
  switch (parser.command_letter) {
    ...
    case 'M': switch (parser.codenum) {
      ...
      case 502: M502(); break;                                    // M502: Revert to default settings
        ...
        case 750: M750(); break;                                  // M750: Run embedded pen plotter demo
        case 751: M751(); break;                                  // M751: Pen plotter utility controls
        case 752: M752(); break;                                  // M752: Draw centered vector text
        case 753: M753(); break;                                  // M753: Generate centered plotter art
      #endif
