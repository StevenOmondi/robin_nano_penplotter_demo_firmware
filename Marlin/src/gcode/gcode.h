 ...
 * M750 - Run an embedded pen plotter demo: "M750 D<demo>". (Requires PENPLOTTER_EMBEDDED_DEMOS)
 * M751 - Pen plotter Z-lift, speed, center, and demo shortcuts. (Requires PENPLOTTER_EMBEDDED_DEMOS)
 * M752 - Draw centered vector text: M752 F<font> S<size> "Text". (Requires PENPLOTTER_EMBEDDED_DEMOS)
 * M753 - Generate centered pen plotter art. (Requires PENPLOTTER_EMBEDDED_DEMOS)
