...
#define LV_COLOR_BACKGROUND          ANDROID_BG_COLOR
#define TFT_LV_PARA_BACK_BODY_COLOR  ANDROID_ACCENT_COLOR
...
#define PARA_SEL_ICON_TEXT_COLOR  ANDROID_ACCENT_COLOR;
...
#define TFT35
  ...
  #define TITLE_XPOS         14    // TFT_screen.title_xpos
  #define TITLE_YPOS          8    // TFT_screen.title_ypos
...
extern lv_style_t style_android_header;
extern lv_style_t style_android_panel;
extern lv_style_t style_android_chip;
extern lv_style_t style_android_accent;
extern lv_style_t style_android_muted;
