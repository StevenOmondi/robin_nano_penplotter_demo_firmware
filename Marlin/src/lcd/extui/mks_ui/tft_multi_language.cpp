...
machine_common_def machine_menu;
  ...
  static void apply_plotter_language_overrides() {
    main_menu.title = "Pen Plotter";
    main_menu.print = "Plot";

    file_menu.title = "Plot Files";

    common_menu.print_special_title = "Plotting";
    common_menu.pause_special_title = "Paused";
    common_menu.operate_special_title = "Plot Options";

    printing_menu.title = "Plotting";
    printing_menu.option = "Options";
    printing_menu.stop = "Stop";
    printing_menu.pause = "Pause";
    printing_menu.resume = "Resume";

    operation_menu.title = "Plot Options";
    operation_menu.speed = "Speed";
    operation_menu.move = "Move";
    operation_menu.more = "More";

    pause_menu.title = "Paused";
    pause_menu.resume = "Resume";
    pause_menu.stop = "Stop";
    pause_menu.move = "Move";
    pause_menu.more = "More";

    speed_menu.title = "Plot Speed";
    speed_menu.move = "Motion";
    speed_menu.move_speed = "Speed";
    speed_menu.extrude = "Pen";
    speed_menu.extrude_speed = "Pen Speed";

    MachinePara_menu.title = "Plotter Settings";
    MachinePara_menu.MachineSetting = "Motion Limits";
    MachinePara_menu.MotorSetting = "Motor Settings";
    MachinePara_menu.AdvanceSetting = "Advanced";

    machine_menu.MachineConfigTitle = "Motion Limits";
    machine_menu.AccelerationConf = "Acceleration";
    machine_menu.MaxFeedRateConf = "Max Feedrate";
    machine_menu.JerkConf = "Jerk";
    machine_menu.PrintAcceleration = "Motion Accel";
    machine_menu.RetractAcceleration = "Disabled";
    machine_menu.TravelAcceleration = "Travel Accel";

    print_file_dialog_menu.print_file = "Plot this file?";
    print_file_dialog_menu.cancel_print = "Stop plot?";
    print_file_dialog_menu.print_finish = "Plot complete";
    print_file_dialog_menu.print_time = "Plot time: ";
    print_file_dialog_menu.reprint = "Plot again";
    print_file_dialog_menu.print_from_breakpoint = "Resume plot?";
  }
#endif
...
void disp_language_init() {
  ...
  #if ENABLED(PENPLOTTER_EMBEDDED_DEMOS)
    apply_plotter_language_overrides();
  #endif
}
