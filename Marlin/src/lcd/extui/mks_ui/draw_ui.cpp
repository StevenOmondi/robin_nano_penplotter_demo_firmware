...
lv_style_t style_android_header;
lv_style_t style_android_panel;
lv_style_t style_android_chip;
lv_style_t style_android_accent;
lv_style_t style_android_muted;
...
void tft_style_init() {
  ...
  tft_style_scr.text.color        = ANDROID_TEXT_COLOR;
  tft_style_scr.text.sel_color    = ANDROID_TEXT_COLOR;
  ...
  style_android_header.text.font         = &TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);

  lv_style_copy(&style_android_panel, &lv_style_plain);
  style_android_panel.body.main_color   = ANDROID_SURFACE_COLOR;
  style_android_panel.body.grad_color   = ANDROID_SURFACE_COLOR;
  style_android_panel.body.border.color = ANDROID_SURFACE_ALT_COLOR;
  style_android_panel.body.border.width = 1;
  style_android_panel.body.shadow.width = 0;
  style_android_panel.body.radius       = 8;
  style_android_panel.text.color        = ANDROID_TEXT_COLOR;
  style_android_panel.text.font         = &TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);

  lv_style_copy(&style_android_chip, &style_android_panel);
  style_android_chip.body.main_color   = ANDROID_SURFACE_ALT_COLOR;
  style_android_chip.body.grad_color   = ANDROID_SURFACE_ALT_COLOR;
  style_android_chip.body.border.color = ANDROID_ACCENT_DARK_COLOR;
  style_android_chip.body.radius       = LV_RADIUS_CIRCLE;
  style_android_chip.text.color        = ANDROID_MUTED_TEXT_COLOR;

  lv_style_copy(&style_android_accent, &style_android_panel);
  ...
  style_android_muted.body.grad_color   = LV_COLOR_BACKGROUND;
  style_android_muted.text.color        = ANDROID_MUTED_TEXT_COLOR;
  style_android_muted.text.sel_color    = ANDROID_MUTED_TEXT_COLOR;
  style_android_muted.text.font         = TERN(HAS_SPI_FLASH_FONT, &gb2312_puhui32, LV_FONT_DEFAULT);
  style_android_muted.line.width        = 0;
  style_android_muted.text.letter_space = 0;
  style_android_muted.text.line_space   = -5;
  ...
  tft_style_label_pre.text.color      = ANDROID_ACCENT_COLOR;
  tft_style_label_pre.text.sel_color  = ANDROID_ACCENT_COLOR;
  tft_style_label_rel.body.main_color = LV_COLOR_BACKGROUND;
  tft_style_label_rel.body.grad_color = LV_COLOR_BACKGROUND;
  tft_style_label_rel.text.color      = ANDROID_TEXT_COLOR;
  tft_style_label_rel.text.sel_color  = ANDROID_TEXT_COLOR;
  ...
  style_para_value_pre.body.main_color = ANDROID_ACCENT_DARK_COLOR;
  style_para_value_pre.body.grad_color = ANDROID_ACCENT_DARK_COLOR;
  style_para_value_pre.text.color      = ANDROID_TEXT_COLOR;
  style_para_value_pre.text.sel_color  = ANDROID_TEXT_COLOR;
  style_para_value_rel.body.main_color = ANDROID_SURFACE_ALT_COLOR;
  style_para_value_rel.body.grad_color = ANDROID_SURFACE_ALT_COLOR;
  style_para_value_rel.text.color      = ANDROID_TEXT_COLOR;
  style_para_value_rel.text.sel_color  = ANDROID_TEXT_COLOR;
  ...
  style_num_key_pre.body.main_color = ANDROID_ACCENT_DARK_COLOR;
  style_num_key_pre.body.grad_color = ANDROID_ACCENT_DARK_COLOR;
  style_num_key_pre.text.color      = ANDROID_TEXT_COLOR;
  style_num_key_pre.text.sel_color  = ANDROID_TEXT_COLOR;
  style_num_key_rel.body.main_color = ANDROID_SURFACE_ALT_COLOR;
  style_num_key_rel.body.grad_color = ANDROID_SURFACE_ALT_COLOR;
  style_num_key_rel.text.color      = ANDROID_TEXT_COLOR;
  style_num_key_rel.text.sel_color  = ANDROID_TEXT_COLOR;
  ...
  style_num_text.body.main_color   = ANDROID_SURFACE_COLOR;
  style_num_text.body.grad_color   = ANDROID_SURFACE_COLOR;
  style_num_text.text.color        = ANDROID_TEXT_COLOR;
  style_num_text.text.sel_color    = ANDROID_TEXT_COLOR;
  ...
  style_sel_text.text.color        = ANDROID_ACCENT_COLOR;
  style_sel_text.text.sel_color    = ANDROID_ACCENT_COLOR;
  ...
  style_line.line.color   = ANDROID_ACCENT_COLOR;
  style_line.line.width   = 1;
  style_line.line.rounded = 1;

  lv_style_copy(&style_para_value, &lv_style_plain);
  style_para_value.body.border.color = ANDROID_SURFACE_ALT_COLOR;
  style_para_value.body.border.width = 1;
  style_para_value.body.main_color   = ANDROID_SURFACE_COLOR;
  style_para_value.body.grad_color   = ANDROID_SURFACE_COLOR;
  style_para_value.body.shadow.width = 0;
  style_para_value.body.radius       = 8;
  style_para_value.text.color        = ANDROID_TEXT_COLOR;
  ...
  style_para_back.body.border.color = ANDROID_ACCENT_DARK_COLOR;
  ...
  style_btn_rel.body.border.color = ANDROID_SURFACE_ALT_COLOR;
  style_btn_rel.body.border.width = 1;
  style_btn_rel.body.main_color   = ANDROID_SURFACE_COLOR;
  style_btn_rel.body.grad_color   = ANDROID_SURFACE_ALT_COLOR;
  style_btn_rel.body.shadow.width = 2;
  style_btn_rel.body.shadow.type  = LV_SHADOW_BOTTOM;
  style_btn_rel.body.radius       = 10;
  style_btn_rel.text.color        = ANDROID_TEXT_COLOR;
  style_btn_rel.text.font         = &TERN(HAS_SPI_FLASH_FONT, gb2312_puhui32, lv_font_roboto_22);

  lv_style_copy(&style_btn_pr, &style_btn_rel);
  style_btn_pr.body.border.color = ANDROID_ACCENT_DARK_COLOR;
  style_btn_pr.body.main_color   = ANDROID_ACCENT_DARK_COLOR;
  style_btn_pr.body.grad_color   = ANDROID_ACCENT_COLOR;
  style_btn_pr.body.shadow.width = 2;
  style_btn_pr.text.color        = ANDROID_TEXT_COLOR;
  ...
  lv_bar_style_indic.text.color        = ANDROID_ACCENT_COLOR;
  lv_bar_style_indic.image.color       = ANDROID_ACCENT_COLOR;
  lv_bar_style_indic.line.color        = ANDROID_ACCENT_COLOR;
...
lv_obj_t* lv_screen_create(DISP_STATE newScreenType, const char *title) {
  ...
  lv_obj_t *header = lv_obj_create(scr, nullptr);
  lv_obj_set_style(header, &style_android_header);
  lv_obj_set_pos(header, 0, 0);
  lv_obj_set_size(header, TFT_WIDTH, titleHeight);
...
void lv_android_status_chip(lv_obj_t *scr, const char *text, lv_coord_t x, lv_coord_t y, lv_coord_t w) {
  lv_obj_t *chip = lv_obj_create(scr, nullptr);
  lv_obj_set_style(chip, &style_android_chip);
  lv_obj_set_pos(chip, x, y);
  lv_obj_set_size(chip, w, 26);

  lv_obj_t *label = lv_label_create_empty(chip);
  lv_obj_set_style(label, &style_android_chip);
  lv_label_set_text(label, text);
  lv_obj_align(label, chip, LV_ALIGN_CENTER, 0, 0);
}

void lv_android_home_indicator(lv_obj_t *scr) {
  lv_obj_t *pill = lv_obj_create(scr, nullptr);
  lv_obj_set_style(pill, &style_android_accent);
  lv_obj_set_pos(pill, (TFT_WIDTH - 96) / 2, TFT_HEIGHT - 12);
  lv_obj_set_size(pill, 96, 5);
}
