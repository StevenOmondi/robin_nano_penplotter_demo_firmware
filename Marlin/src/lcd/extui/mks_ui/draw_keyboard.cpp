    ...
    if (kb->event_cb != lv_kb_def_event_cb) {
      ...
      switch (keyboard_value) {
        ...
        case GCodeCommand:
          ...
          goto_previous_ui();
          break;
        case plotterTextInput:
          plotter_text_set(ret_ta_txt);
          goto_previous_ui();
          break;
        default: break;
      }
...
void lv_draw_keyboard() {
  ...
  rel_style.body.main_color   = ANDROID_SURFACE_ALT_COLOR;
  rel_style.body.grad_color   = ANDROID_SURFACE_COLOR;
  rel_style.body.border.color = ANDROID_ACCENT_DARK_COLOR;
  rel_style.text.color        = ANDROID_TEXT_COLOR;

  lv_style_copy(&pr_style, &lv_style_btn_pr);
  pr_style.body.radius       = 0;
  pr_style.body.border.width = 1;
  pr_style.body.main_color   = ANDROID_ACCENT_DARK_COLOR;
  pr_style.body.grad_color   = ANDROID_ACCENT_COLOR;
  pr_style.body.border.color = ANDROID_ACCENT_COLOR;
  pr_style.text.color        = ANDROID_TEXT_COLOR;
  ...
  switch (keyboard_value) {
    ...
    case GCodeCommand:
      ...
      break;
    case plotterTextInput:
      lv_ta_set_text(ta, plotter_text_get());
      break;
    default:
      lv_ta_set_text(ta, "");
  }
